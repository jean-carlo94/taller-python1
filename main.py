...
def menu():
    ...
    print("|                                                                    |")
    print("| \033[42m(1)\033[0m.\033[33m Ver todas las mascotas\033[0m                                        |")
    print("|                                                                    |")
    print("| \033[42m(2)\033[0m.\033[33m Registrar mascota\033[0m                                             |")
    print("|                                                                    |")
    print("| \033[42m(3)\033[0m.\033[33m Adoptar una mascota\033[0m                                           |")
    print("|                                                                    |")
    print("| \033[42m(4)\033[0m.\033[33m Ver mascotas disponibles\033[0m                                      |")
    print("|                                                                    |")
    print("| \033[42m(5)\033[0m.\033[33m Ver mascotas Adoptadas\033[0m                                        |")
    print("|                                                                    |")
...
def actions():
    ...
    if opt == "1":
        print("|                                                                    |")
        print("|\033[42m Listado de Mascotas:\033[0m                                               |")
        print("|                                                                    |")
        
        helpers.listar_mascotas()
        ...
        print("|                                                                    |")
        print("|\033[42m Registro de mascota:\033[0m                                               |")
        print("|                                                                    |")
        
        helpers.registrar_mascota()
        ...
        helpers.listar_mascotas_disponibles()
        ...
        helpers.listar_mascotas_adoptadas()
